...
public class EnterSharedElementCallback extends SharedElementCallback {
    ...
    public EnterSharedElementCallback(Context context) {
        ...
        mStartTextSize = res.getDimensionPixelSize(R.dimen._20ssp);
        mEndTextSize = res.getDimensionPixelSize(R.dimen._16ssp);
        mStartColor = res.getColor(R.color.colorPrimary);
