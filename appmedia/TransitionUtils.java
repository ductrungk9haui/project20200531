...
public final class TransitionUtils {
    ...
    public static Transition makeSharedElementEnterTransition(Context context) {
        ...
        changeBounds.addTarget(R.id.txtSinger);
        changeBounds.addTarget(context.getString(R.string.candyman));
        set.addTransition(changeBounds);

        Transition textSize = new TextSizeTransition();
        textSize.addTarget(R.id.txtSinger);
        textSize.addTarget(context.getString(R.string.candyman));
