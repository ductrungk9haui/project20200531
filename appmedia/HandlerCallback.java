...
public class HandlerCallback extends SharedElementCallback {
    ...
    public void onSharedElementStart(List<String> sharedElementNames, List<View> sharedElements, List<View> sharedElementSnapshots) {
        for (View v : sharedElements) {
          ...
          /*  TextView textView = (TextView) v;
             widthOld = textView.getMeasuredWidth();
             heightOld = textView.getMeasuredHeight();*/
    ...
    public void onSharedElementEnd(List<String> sharedElementNames, List<View> sharedElements, List<View> sharedElementSnapshots) {
        for (View v : sharedElements) {
            ...
            float newWidth = textView.getMeasuredWidth();
            float newHeight = textView.getMeasuredHeight();

            // Layout the TextView in the center of its container, accounting for its new width/height.
            int widthDiff = (int) (newWidth - widthOld);
            int heightDiff = (int) (newHeight - heightOld);
